...
public interface Grafo<T> {
	 ...
	 * En caso que el vertice tenga conexiones con otros vertices, se eliminan todas
	 * sus conexiones.
	 * 
	 * @param v
	 */
	...
	/**
	 * Retorna true en caso que el grafo no contenga ningun vertice. False en caso
	 * contrario.
	 * 
	 * @return
	 */
